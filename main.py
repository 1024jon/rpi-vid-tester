...
class MyApp(App):
    ...
    def build(self):
        # Set up the layout:
        layout = GridLayout(cols=7, spacing=30, padding=30, row_default_height=20)
        ...
        btn11 = Button(text="1680x1050@60Hz")
        btn11.bind(on_press=set1680)          
        btn12 = Button(text="1360x768@60Hz")
        btn12.bind(on_press=set1360)
        
        btn13 = Button(text="1280x1024@60Hz")
        btn13.bind(on_press=set12801024)        
        btn14 = Button(text="1280x960@60Hz")
        btn14.bind(on_press=set1280960)   
        btn15 = Button(text="1366x768@60Hz")
        btn15.bind(on_press=set1366)   
        btn16 = Button(text="1920x1200@60Hz")
        btn16.bind(on_press=set1920)  
        btn17 = Button(text="1440x900@60Hz")
        btn17.bind(on_press=set1440)   
        btn18 = Button(text="1400x1050@60Hz")
        ...
        layout.add_widget(Label(text="Select Resolution(Primary) --->"))
        ...
        layout.add_widget(Label(text="Select Resolution(Odd) --->"))
